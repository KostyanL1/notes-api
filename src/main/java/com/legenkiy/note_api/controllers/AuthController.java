...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> register(@Valid @RequestBody UserDto userDto, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
